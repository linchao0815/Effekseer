...
const char16_t* examplesFiles[] = {
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_simple.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_mass.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_tornade.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_trails.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_turbulence.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_line_emit.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_mesh_emit.efkefc",
	EFK_EXAMPLE_ASSETS_DIR_U16 u"GpuParticles_mesh_shape.efkefc",
};
